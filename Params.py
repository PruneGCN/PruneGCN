...
def parser_loader():
    ...
    parser.add_argument('--esc_train_imp', default=-1, type=int, help= "escape training for the pruning epoch esc_train_imp")
    ...
    parser.add_argument('--hyper_contr_start_imp', default=2, type=int, help='the pruning step to start using subspace self-contrastive uniformity constraint')
    parser.add_argument('--hyper_contr_end_imp', default=13, type=int, help='the pruning step to stop using subspace self-contrastive uniformity constraint')    
    ...
    # Pruning
    parser.add_argument('--keep_adj_weights2next_imp', default=False, type=str2bool, help='whether to keep the learned edge weights to the next pruning step, False by default')                
    ...
    parser.add_argument('--gpu', default='3', type=str, help='indicates which gpu to use')
    ...
    parser.add_argument('--IMP_START', default=1, type=int, help='the starting pruning epoch')
    parser.add_argument('--IMP_NUM', default=13, type=int, help='the ending pruning epoch')
